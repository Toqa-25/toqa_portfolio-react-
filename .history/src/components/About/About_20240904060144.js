  ...
  return (
      <div className="container about">
        ...
        <div className="about-info">
          ...
          <p class="capitalize desc coder-desc ">
            I start my  journey of learning from <Link to="https://elzero.org" className="special-them-color capitalize" target="_blank" rel="noopener noreferrer">elzero academy</Link>, and  I continue  in it because I'm passionate about what i do </p>
        </div>
