  ...
  return (
      <div className="container about">
        ...
        <div className="about-info">
          ...
          I have more   than 3 years of experience in this field, and I'm passionate about my job so I can code any design in HTML, CSS, Bootstrap, and JS in responsive design for all screens</p>
        </div>
