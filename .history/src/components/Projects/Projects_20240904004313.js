    ...
    <div className="container projects flex-column">
      ...
      <div className="projects-list" >
        ...
        <ul className={"projects-list-items " + (hideList && "hide")} >    
          <li  className="capitalize projects-list-item" onClick={hideListFun}>> <Link to="/projects">All</Link> </li>
          <li  className="capitalize projects-list-item" onClick={hideListFun}>> <Link to="/SCSS_Projects">SCSS</Link> </li> 
          <li  className="capitalize projects-list-item"onClick={hideListFun}>> <Link to="/Figma_Projects">Figma</Link> </li>
