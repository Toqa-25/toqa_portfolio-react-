...
const Projects = () => {
  ...
  return (
    <div className="container projects">
      ...
      <Outlet />
      <img src={ require('./../../images/portfolio/travel-website.png')} alt="" className="project-img" />
      <div className="Projects-items">
      {projectsData.map((item) => {
        {console.log("images")}
        let img = ('./../../images/portfolio/'item.projectImg)
        return (
          <div className="project-item">
            <h5 className="capitalize">{item.projectName}</h5>
            <img src={ require(`./../../images/portfolio/${img}`)} alt="" className="project-img" />
