  ...
  return (
    <div className="container projects flex-column">
      ...
      <div className="projects-list" >
        <div className="capitalize project-list-header" onClick={showListFun}> 
          projects 
           <span icon="fa-solid fa-caret-down drop-icon"><FontAwesomeIcon icon="fa-solid fa-caret-down drop-icon" /></span> 
        </div>
        <ul className={"projects-list-items " + (showList && "hide")} >    
